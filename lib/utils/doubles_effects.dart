...
DoublesModifiers computeDoublesModifiers({
  ...
  // special-only guard).
  // [move] must be the transformMove output: conditional spread
  // (Expanding Force on Psychic Terrain) arrives as a tag, so this
  // function never re-derives field conditions.
